...
const SECTIONS = [
  ...
  ['07', "A Telegram bot reads the same contracts the dashboard does. Ask it for markets, the pool, or any position. Put an address on watch, and it messages you when that position's health factor slips below one point one five, and again once it recovers above one point two five."],
