/**
 * xStocks collateral on X Layer mainnet. `redstoneFeed` is the 24/5 RedStone feed for the underlying share
 * (undefined where no public feed exists, so the asset cannot be priced or lent against yet).
 *
